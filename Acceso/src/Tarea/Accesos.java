...
public class Accesos extends javax.swing.JFrame {
    private Connection conexion;//establecer conexion con base de datos
    private Statement sentencia;//crear el enunciado en SQL para la conexion
    private ResultSet resultado;//obtener el resultado de la sentencia
    int cont=0;
    ...
    public void conectarBD(){
        try{
            Class.forName("com.mysql.jdbc.Driver");//especificar el driver a utilizar
            conexion=DriverManager.getConnection("jdbc:mysql://localhost:3306/escuela", "root", "");//generar la conexion
            if(conexion!=null){//verificar que si se haga la conexion
                sentencia=conexion.createStatement();
                JOptionPane.showMessageDialog(null, "Conexion establecida con la BD");
            }
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null, "No se pudo establecer la conexion "+e);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONTROL DE ACCESO AL SISTEMA");
    ...
    private void JBotonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBotonLoginActionPerformed
        ...
        if(TxtUsuario.getText().equals("") || TxtContrasena.getText().equals("")){
            ...
            try{
            conectarBD();
            resultado=sentencia.executeQuery("SELECT nombre_u,contrasena FROM usuarios"
                        +" WHERE nombre_u='"+TxtUsuario.getText()+"' and "
